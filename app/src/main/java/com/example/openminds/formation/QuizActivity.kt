...
import com.example.openminds.utils.Quiz
import com.example.openminds.utils.getQuiz
import com.example.openminds.utils.getUserId
import com.example.openminds.utils.isLogged
import com.example.openminds.utils.submitQuiz
    ...
    private fun submitAnswers() {
        ...
        lifecycleScope.launch {
            try {
                ...
                val result =
                    submitQuiz(this@QuizActivity, userId, quizId, userAnswers.joinToString(","))
